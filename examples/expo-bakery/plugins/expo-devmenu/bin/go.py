#!/usr/bin/env python3
"""Send Cmd+KeyD to the focused device — the RN/Expo Dev menu chord."""
...
envelope = {"type": "key", "code": "KeyD", "modifiers": ["command"]}
...
print(json.dumps({"ok": True, "rows": [{"title": "Dev menu sent (⌘D)", "severity": "info"}]}))
